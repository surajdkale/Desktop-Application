...
public class withdrawal extends javax.swing.JFrame {
    ...
    String usernamefromaccdetails;
    String Toaccnum = "To Self Account";
      String componentName = "Withdrawal";
  ...
  public withdrawal(String idofuse){
      this.usernamefromaccdetails=idofuse;
      System.out.println(usernamefromaccdetails);
       initComponents();
        Toolkit toolkit =getToolkit();
        Dimension size = toolkit.getScreenSize();
        setLocation(size.width/2-getWidth()/2,size.height/2-getHeight()/2);
   ...
   //Playing Sound Effects....
    ...
    private void initComponents() {
        ...
        select.setText("Select an amount to withdraw");
    ...
    private void withdraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_withdraActionPerformed
       ...
       //for fetching account number from atmreg...
            ...
            Statement stmt = conn.createStatement();
                 String sql = "select * from atmreg where ID='"+usernamefromaccdetails+"'";
        ...
        try{
                ...
                pstmt.setString(1,usernamefromaccdetails);
...
//                pstmt.setString(7,Dates.getText());
        ...
        try{//write totalamount
                Class.forName("com.mysql.jdbc.Driver");
                String sql = "UPDATE atmreg SET BALANCE ='"+maintotal+"'WHERE ID='"+usernamefromaccdetails+"'";
                conn = DriverManager.getConnection("jdbc:mysql://localhost/atm","root","");
                 pstmt = conn.prepareStatement(sql); 
       ...
       new Buffer(usernamefromaccdetails,amounttext.getText()).setVisible(true);
       dispose();
